...
const DEFAULT_MODELS: ModelProfile[] = [
  ...
  { provider: 'anthropic', model: 'claude-3-haiku', costPer1kTokens: 0.25, avgLatencyMs: 500, qualityScore: 0.88, maxTokens: 200000 },
  { provider: 'openai', model: 'gpt-4o', costPer1kTokens: 2.5, avgLatencyMs: 1200, qualityScore: 0.94, maxTokens: 128000 },
  { provider: 'anthropic', model: 'claude-sonnet-4', costPer1kTokens: 3.0, avgLatencyMs: 1000, qualityScore: 0.95, maxTokens: 200000 },
